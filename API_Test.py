...
webtestURL = 'https://api.careeronestop.org/v1/jobsearch/bSzANWeySBZwyEB/developer/Nashville%2C%20TN/25/jobtitle/ASC/0/10/10?source=NLx&showFilters=false'
gapExURL = 'https://api.careeronestop.org/v1/skillgap/bSzANWeySBZwyEB/41303103/41309901/reston%2C%20va/25'
response = requests.get(webtestURL , headers={'Authorization': apiToken})
print(response)
print(response.url)
print(response.text)
with open('respons_' + current_time +'.json', 'w') as fout:
